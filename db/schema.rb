...
ActiveRecord::Schema[8.1].define(version: 2026_09_02_100100) do
  ...
  create_table "order_exports", force: :cascade do |t|
    ...
    t.check_constraint "status::text = ANY (ARRAY['pending'::character varying, 'processing'::character varying, 'completed'::character varying, 'failed'::character varying]::text[])", name: "order_exports_valid_status"
  end
  ...
  create_table "seller_performance_reports", force: :cascade do |t|
    ...
    t.index ["seller_id", "created_at"], name: "index_seller_performance_reports_on_seller_id_and_created_at"
